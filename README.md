...
module "vsphere" {
  source     = "terraform-aws-modules/storagegateway/aws//modules/vmware-sgw"
...
```hcl
module "sgw" {
  source             = "terraform-aws-modules/storagegateway/aws//modules/aws-sgw"
  name               = "my-sgw"
...
#######################################
module "smb_share" {
  source        = "terraform-aws-modules/storagegateway/aws//modules/s3-smb-share"
