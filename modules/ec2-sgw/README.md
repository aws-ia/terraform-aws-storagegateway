...
| <a name="input_ssh_public_key_path"></a> [ssh\_public\_key\_path](#input\_ssh\_public\_key\_path) | Optional attribute to the absolute file path to the the public key for the EC2 Key pair | `string` | `""` | no |
