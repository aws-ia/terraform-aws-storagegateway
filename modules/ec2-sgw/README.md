...
| <a name="input_instance_type"></a> [instance\_type](#input\_instance\_type) | The instance type to use for the Storage Gateway. Instance types supported are m5.xlarge (minimum for small deployment), m5.2xlarge (medium), or m5.4xlarge (large). M6i variants are also supported. | `string` | `"m5.xlarge"` | no |
